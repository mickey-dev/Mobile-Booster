...
<head>
    ...
    <style type="text/css">
        ...
        .woocommerce.columns-3 ul.products li.product .sb-prodict-info{
            display: none;
        }
        .woocommerce.columns-3 ul.products li.product .product-right{
            width: 100%;
        }
        .woocommerce.columns-3 ul.products li.product .col-sm-3{
            width: 18%;
            float: left;
        }
        .woocommerce.columns-3 ul.products li.product .col-sm-3 img{
            margin-right: 2%;
...
<body>
<!-- Start of preheader -->
<table width="100%" style="background-color: #09b0da" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    <tbody>
    <tr>
        <td>
                                    ...
                                    <table width="280" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td align="left" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff">
                                                <a href="<?= get_home_url()?>" style="text-decoration: none; color: #ffffff">Home</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <table width="280" align="left" border="0" cellpadding="0" cellspacing="0" class="emhide">
                                        ...
                                        <tr>
                                            <td align="right" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff">
                                                <a href="<?= get_home_url().'/shop'?>" style="text-decoration: none; color: #ffffff">Shop</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
    ...
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                ...
                <tr>
                    <td width="100%">
                        <table style="background-color: #ffffff" width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                            <tbody>
                            <tr>
                                <!-- start of image -->
                                <td align="center">
                                    <a target="_blank" href="<?= get_home_url(); ?>">
                                        <?php $logo = theme_option('logo'); if ($logo && !empty($logo['url'])): ?>
                                            <img src="<?= $logo['url'] ?>" height="<?= $logo['height'] ?>" width="<?= $logo['width'] ?>" alt="<?= bloginfo('name') ?> logo"  class="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;">
                                        <?php else:
                                            bloginfo('name');
                                        endif; ?>
                                    </a>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; font-weight:bold; color: #333333; text-align:left;line-height: 24px;">
                                                <?php
                                                if(isset($params['title']) && !empty($params['title'])) echo $params['title'];
                                                ?>
                                            </td>
                                        </tr>
                                        <!-- End of Title -->
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #333333; text-align:left;line-height: 24px;">
                                                <?php foreach($params['data'] as $_key => $_param): ?>
                                                    <p><?= ucwords($_key) ?>: <?= $_param ?></p>
                                                <?php endforeach ?>
                                            </td>
                                        </tr>
                                        <!-- End of content -->
...
<!-- Start of postfooter -->
<table width="100%" bgcolor="#09b0da" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    <tbody>
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
