...
<div class="col-xs-12 no-padding cart-subtotal">
    <div class="col-xs-6 text-right"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></div>
...
<?php if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) : ?>
    <?php if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) : ?>
        <?php foreach ( WC()->cart->get_tax_totals() as $code => $tax ) : // phpcs:ignore WordPress.WP.GlobalVariablesOverride.OverrideProhibited ?>
            <div class="col-xs-12 no-padding tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
...
<div class="col-xs-12 no-padding order-total">
    <div class="col-xs-6 text-right"><?php esc_html_e( 'Total', 'woocommerce' ); ?></div>
