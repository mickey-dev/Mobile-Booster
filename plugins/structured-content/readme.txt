...
Tags: json-ld, FAQPage, JobPosting, Event, course, wpsc, structured content, micro data, structured data
...
**The plugin works fine with the Gutenberg & TinyMCE!** Currently the plugin offers five structured data elements:
- FAQPage
- JobPosting
- Event
- Course
...
**JobPosting**
> [sc_fs_job html="true" title="JobPosting Title" title_tag="h3" description="JobPosting Description" valid_through="2019-11-08" employment_type="FULL_TIME" company_name="Your Company" same_as="https://gorbo.de" logo_id="309" street_address="anystreet 4" address_locality="Any City" address_region="ST" postal_code="01234" address_country="US" currency_code="USD" quantitative_value="200" base_salary="HOUR" css_class="your-class" ]

**Event**
> [sc_fs_event html="true" title="Event title" title_tag="h2" event_location="Event location" start_date="2019-08-22T10:25" end_date="2019-08-22T11:25" street_address="Any Street" address_locality="Any City" address_region="CA" postal_code="Any Postal Code" address_country="US" image_id="" performer="PerformingGroup" performer_name="John Doe" offer_availability="InStock" offer_url="https://example.com" currency_code="EUR" price="40.00" offer_valid_from="2019-08-20T10:25" css_class="" ] Event description [/sc_fs_event]

**Course**
> [sc_fs_course html="true" title="Course title" title_tag="h3" provider_name="Provider Name" provider_same_as="https://example.com" css_class="your-class" ]Course-Description – you can format it as you want[/sc_fs_course]

**Person**
> [sc_fs_person html="true" person_name="John Doe" job_title="CEO of Something" image_id="" street_address="Aqny Street" address_locality="Any City" address_region="CS" postal_code="Any Potal Code" address_country="US" email="john-doe@example.com" url="https://example.com" telephone="(123) 45678" css_class="your-class" colleague="Jane Doe, Max Doe" ]
