					...
					<?php if ( ! empty( $item['image'] ) ) : ?>
                        <figure>
                            <a href="<?php echo $item['img_url']; ?>" title="<?php echo $item['img_alt']; ?>">
                                <img src="<?php echo $item['thumbnail_url']; ?>" alt="<?php echo $item['img_alt']; ?>"/>
                            </a>
                            <meta content="<?php echo $item['img_url'] ?>">
                            <meta content="<?php echo $item['img_size'][0]; ?>">
                            <meta content="<?php echo $item['img_size'][1]; ?>">
                        </figure>
					<?php endif; ?>
                    <p>
