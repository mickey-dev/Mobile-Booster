                            ...
                            <div class="sc_input-group">
                                ...
                                <div>
                                    <figure class="sc_company-logo-wrapper">
                                        <a href="<?php echo $atts['logo_url']; ?>" title="<?php echo $atts['logo_alt']; ?>">
                                            <img src="<?php echo $atts['thumbnail_url']; ?>" alt="<?php echo $atts['logo_alt']; ?>"/>
                                        </a>
            ...
            <div class="sc_grey-box">
                ...
                <div class="sc_input-group">
                    ...
                    <div class="wp-block-structured-content-job__validThrough">
						<?php echo date( 'd.m.Y', strtotime( $atts['valid_through'] ) ); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script type="application/ld+json">
  {
		...
		"datePosted" : "<?php echo get_the_date( 'Y-m-d', get_the_ID() ); ?>",
		"validThrough" : "<?php echo $atts['valid_through'] ?>",
