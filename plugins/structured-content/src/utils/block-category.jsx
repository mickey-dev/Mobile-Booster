...
const categoryIcon =
          <svg className="components-structuredcontent-logo-icon components-structuredcontent-logo-icon--red components-panel__icon" width="67" height="10" fill="none" xmlns="http://www.w3.org/2000/svg" style={ { margin: '3.5px 10px' } }>
              <g clip-path="url(#clip0)" fill="#F03009">
