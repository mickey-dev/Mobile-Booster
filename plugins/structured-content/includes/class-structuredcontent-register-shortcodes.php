...
class StructuredContent_Shortcodes {
	...
	static public function multi_faq( $atts, $content = null ) {
		...
		foreach ( $atts as $key => $merged_att ) {
			if ( strpos( $key, 'headline' ) !== false || strpos( $key, 'question' ) !== false || strpos( $key, 'answer' ) !== false || strpos( $key, 'image' ) !== false ) {
		...
		ob_start();
		include STRUCTURED_CONTENT_PLUGIN_DIR . 'shortcodes/multi-faq.php';
	...
	static public function job( $atts, $content = null ) {
		...
		ob_start();
		include STRUCTURED_CONTENT_PLUGIN_DIR . 'shortcodes/job.php';
		$output = ob_get_contents();
		ob_end_clean();
	...
	static public function event( $atts, $content = null ) {
		...
		ob_start();
		include STRUCTURED_CONTENT_PLUGIN_DIR . 'shortcodes/event.php';
		$output = ob_get_contents();
		ob_end_clean();
	...
	static public function person( $atts, $content = null ) {
		...
		ob_start();
		include STRUCTURED_CONTENT_PLUGIN_DIR . 'shortcodes/person.php';
		$output = ob_get_contents();
		ob_end_clean();
	...
	static public function course( $atts, $content = null ) {
		...
		ob_start();
		include STRUCTURED_CONTENT_PLUGIN_DIR . 'shortcodes/course.php';
		$output = ob_get_contents();
		ob_end_clean();
